...
export default function LandingPage({ onSelectRoute, activeUser, onViewDashboard, onTrack, lang, isDarkMode }) {
  ...
  const translations = {
    en: {
      ...
      trackPlaceholder: "Enter Your Email or File ID",
      trackHelp: "Paste your student tracking ID Or your Email to check your file status instantly.",
    ...
    ar: {
      ...
      trackPlaceholder: "أدخل رقم الملف أو بريدك الالكتروني",
